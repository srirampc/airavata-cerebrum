...
if __name__ == "__main__":
    NET_DIR = "./prior/v1_test/network_v1/"
    H5_FILE = f"{NET_DIR}/left_local_edges.edge_types_120.sorted.h5"
    OUT_H5_FILE = f"{NET_DIR}/left_local_edges.edge_types_120.modified.h5"
    EDGE_TYPE = 117
    THRESHOLD = 0.7
