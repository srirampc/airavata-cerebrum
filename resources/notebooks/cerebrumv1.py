...
from mousev1.operations import convert_ctdb_models_to_nest
from mousev1.utils import MVParMethod
...
def get_build_adaptor(nc: NetworkConstructor):
    ...
    from mousev1.dm_network import MVDenseNetwork
    match nc:
        case 'DenseNetwork':
            return DenseNetwork
        case "MVDenseNetwork":
...
class CerebrumRecipeRunner(pydantic.BaseModel):
    ...
    build_adaptor_class: t.Literal['DenseNetwork', 'MVDenseNetwork'] = 'MVDenseNetwork'
...
def recipe_bmtk(
    ...
    from mousev1.comm_interface import default_comm, CommInterface
...
def main(input_config_file: str):
    ...
    comm.log_at_root(_log(), logging.INFO, rcp_runner.model_dump_json(indent=4))
